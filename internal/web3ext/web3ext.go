...
// package web3ext contains gece specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'getSzkAccounts',
			call: 'dece_getSzkAccounts',
			params: 0
		}),
		new web3._extend.Method({
			name: 'genOldIndexPKr',
			call: 'dece_genOldIndexPKr',
			params: 2
		}),
		new web3._extend.Method({
			name: 'sign',
		...
		new web3._extend.Method({
			...
			call: 'dece_signTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'dece_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
        new web3._extend.Method({
			name: 'getBlockTotalRewardByNumber',
			call: 'dece_getBlockTotalRewardByNumber',
			params: 1,
       ...
       new web3._extend.Method({
			...
			call: 'dece_getBlockPosRewardByNumber',
			params: 1,
            inputFormatter: [web3._extend.utils.toHex],
			outputFormatter: web3._extend.utils.toDecimal
		}),
		new web3._extend.Method({
			...
			call: 'dece_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'dece_getRawTransactionByBlockHashAndIndex' : 'dece_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
        ...
        new web3._extend.Method({
			name: 'packMethod',
            call: 'dece_packMethod',	
			params:4
		}),
       new web3._extend.Method({
			name: 'packConstruct',
            call: 'dece_packConstruct',	
			params: 3
		}),
       new web3._extend.Method({
			name: 'unPack',
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'dece_pendingTransactions',
