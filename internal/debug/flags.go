...
import (
	...
	"github.com/dece-cash/go-dece/log/term"
	"github.com/dece-cash/go-dece/metrics"
	"github.com/dece-cash/go-dece/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. dece/*=5,p2p=4)",
		Value: "",
	}
