...
// PeerInfo represents a short summary of the Dece sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Dece protocol version negotiated
...
// Handshake executes the dece protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("dece/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Dece sub-protocol.
type peerSet struct {
