...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (dece/61) or header (dece/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (dece/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both dece/61 and dece/62)
}
