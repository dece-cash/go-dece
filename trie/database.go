...
type Database struct {
	diskdb decedb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb decedb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch decedb.Batch) error {
