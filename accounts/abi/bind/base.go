...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = dece.CallMsg{FromPKr: opts.FromPKr, To: &c.address, Data: input}
...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := dece.CallMsg{FromPKr: &opts.FromPKr, To: contract, Value: value, Data: input}
	...
	msg := dece.CallMsg{From: opts.From, FromPKr: &opts.FromPKr, To: contract, GasPrice: gasPrice, Gas: gasLimit, Value: value, Data: input}
