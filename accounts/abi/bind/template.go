...
import "github.com/dece-cash/go-dece/accounts/abi"
...
import (
	...
	"github.com/dece-cash/go-dece/accounts/abi/bind"
...
{{range $contract := .Contracts}}
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  dece.Subscription     // Subscription for errors, completion and termination
