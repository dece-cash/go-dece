...
func newTester(t *testing.T, confOverride func(*dece.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return dece.New(ctx, ethConf) }); err != nil {
